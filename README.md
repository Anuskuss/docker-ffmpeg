...
Additionally you can also set the `nice`ness of the ffmpeg process via the `NICE` environment variable. Refer to [nice(1)](https://man7.org/linux/man-pages/man1/nice.1.html) to understand what the number mean. Note that negative numbers may require root privileges.
